...
url --url="mirrorsnap.centos.org/DATESTAMP/centos/8/os/x86_64"
...
# System language
lang en_US.UTF-8
repo --name "os" --baseurl="http://mirrorsnap.centos.org/DATESTAMP/centos/8/os/x86_64/" --cost=100
repo --name "updates" --baseurl="http://mirrorsnap.centos.org/DATESTAMP/centos/8/updates/x86_64/" --cost=100
repo --name "extras" --baseurl="http://mirrorsnap.centos.org/DATESTAMP/centos/8/extras/x86_64/" --cost=100
# Network information
